...
fn main() {
    ...
    match cli.command {
        ...
        Command::LabelDefault => {
            render_and_extract::<cases::label_default::LabelDefault>((), output)
        }
        Command::LabelHeading => {
            render_and_extract::<cases::label_heading::LabelHeading>((), output)
        }
