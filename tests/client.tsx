import { AdwaitaProvider, GtkButton, GtkLinkButton, GtkMenuButton, GtkToggleButton } from "@gtk-js/adwaita";
...
const cases: Record<string, () => React.ReactElement> = {
  ...
  "menu-button-icon": () => (
    <GtkMenuButton iconName="open-menu-symbolic" data-testid="target" />
  ),
  "menu-button-flat": () => (
    <GtkMenuButton label="Button" hasFrame={false} data-testid="target" />
  ),
  "menu-button-circular": () => (
    <GtkMenuButton className="circular" data-testid="target" />
  ),
  "menu-button-disabled": () => (
    <GtkMenuButton label="Button" disabled data-testid="target" />
  ),
